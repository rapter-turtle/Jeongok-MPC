...
class AuraMPC(Node):
    def __init__(self):
        ...
        self.Tf = 25 # prediction time 4 sec
        self.N = 50 # prediction horizon
        self.con_dt = 0.5 # control sampling time
        
        Q_mat1 = 1*np.diag([1e1, 1e1, 1e1, 1e1, 1e1, 1e-2, 1e0, 1e1])
        Q_mat_terminal1 = np.diag([1e2, 1e2, 1e5, 1e2, 1e2, 1e-2, 1e0, 1e1])
        R_mat1 = 1*np.diag([1e1, 1e1])

        Q_mat2 = 1*np.diag([1e1, 1e1, 1e1, 1e1, 1e1, 1e-2, 1e0])
        Q_mat_terminal2 = 1*np.diag([1e3, 1e3, 1e5, 1e2, 1e2, 1e-2, 1e0])
        ...
        # Q_mat1 = 1*np.diag([1e1, 1e1, 1e1, 1e2, 1e2, 1e-2, 1e0, 1e1])
        # Q_mat_terminal1 = 1*np.diag([1e2, 1e2, 1e5, 1e2, 1e2, 1e-2, 1e0, 1e1])
        # R_mat1 = 1*np.diag([1e1, 1e1])
    ...
    def run(self):
        ...
        for j in range(self.N+1):
            ...
            yref1 = np.hstack((dock_x,dock_y,dock_psi,0,0,0,0,0,0,0))
